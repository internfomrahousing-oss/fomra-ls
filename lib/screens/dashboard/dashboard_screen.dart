...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List<LandLead> _leadsForFilter(_KpiFilter filter) {
    ...
    return switch (filter) {
      ...
      _KpiFilter.active => leads.where((l) => l.status.isActive).toList(),
      _KpiFilter.acquired =>
        leads.where((l) => l.status.isAcquired).toList(),
      _KpiFilter.rejected =>
        leads.where((l) => l.status.isDropped).toList(),
    };
  }
  ...
  Widget build(BuildContext context) {
    ...
    final prospectPending =
        _countByStatus(LeadStatus.prospectMeetingPending);
    final prospectCompleted =
        _countByStatus(LeadStatus.prospectMeetingCompleted);
    final negotiation = _countByStatus(LeadStatus.negotiation);
    final pendingActions = prospectPending + negotiation;
    ...
    final kpis = [
      ...
      _KpiData(
        ...
        periodLabel: 'Meeting done',
        periodValue: '$prospectCompleted',
